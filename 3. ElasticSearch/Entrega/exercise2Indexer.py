...
def main():
    ...
    es.indices.create(index="tweets-20090624-20090626-en_es-10percent-exercise2", ignore=400, body=argumentos)
...
def procesarLineas(lineas):
    ...
    for linea in lineas:
        ...
        if datos["lang"] == "en":
            datos["_index"] = "tweets-20090624-20090626-en_es-10percent-exercise2"
            datos["_id"] = ident
