...
/**
 * Titulo: Interfaz ContractTypeService
 *
...
public interface ContractTypeService {
	 ...
	 * @throws BusinessException        if: - another type of contract with the same
	 *                                  name already exists
	 */
	 ...
	 * @throws BusinessException        if - the contract type does not exist, or -
	 *                                  there are contracts registered with the
	 *                                  contract type
	 */
	 ...
	 * 
	 * @param dto
	 * @throws IllegalArgumentException if - arg is null - nanme is null or empty -
	 *                                  the number of compensation days is negative
	 * @throws BusinessException        if: - the contract type does not exist, or
	 */
	...
	/**
	 * Titulo: Clase ContractTypeBLDto
	 *
	 * @author Omar Teixeira González, UO281847
	 * @version 18 oct 2022
	 */
