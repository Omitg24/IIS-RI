...
public interface VoucherService {
	/**
	 * Generate the vouchers following one or several policies: - by total number of
	 * workorders in their vehicles - by number of recommendations - by invoices
	 * over 500 euros
	 * 
	 ...
	 * 
	 * @return A list of aggregated information of the vouchers of each client or
	 *         empty if there is no voucher DOES NOT @throws BusinessException.
	 */
