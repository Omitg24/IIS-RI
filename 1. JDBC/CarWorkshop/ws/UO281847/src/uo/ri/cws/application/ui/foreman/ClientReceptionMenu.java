...
public class ClientReceptionMenu extends BaseMenu {
	...
	public ClientReceptionMenu() {
		menuOptions = new Object[][] { { "Foreman > Check in menu", null },
				...
				{ "Add breakdown", AddWorkOrderAction.class }, { "Update breakdown", UpdateWorkOrderAction.class },
				{ "Delete breakdown", NotYetImplementedAction.class }, { "", null },
				{ "List breakdown", NotYetImplementedAction.class },
				{ "Check a breakdown", NotYetImplementedAction.class }, { "", null },
