...
public interface MechanicService {
	 ...
	 * @throws BusinessException        if the mechanic does not exist or if there
	 *                                  are work orders registered for this mechanic
	 *                                  or if there are contracts for this mechanic
	 *                                  (regarding the state)
	 ...
	 * 
	 * @param mechanic A dto identifying the mechanic to update by the field id, and
	 *                 the data to update in name and surname
	 * @throws BusinessException if the mechanic does not exist
	 *                           IllegalArgumentException when the argument is null
	 *                           or any of the fields (id, dni, name, surname) are
	 *                           null or empty
	 */
	 ...
	 * ONLY FOR EXTENSION
	 * 
	 * @return the list of all mechanics registered in the system with a contract in
	 *         force. It might be an empty list if there is no mechanic
	 *
	 *         DOES NOT @throws BusinessException
	 */
