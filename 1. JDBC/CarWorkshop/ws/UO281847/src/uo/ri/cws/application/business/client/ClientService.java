...
public interface ClientService {
	 ...
	 * @throws BusinessException        if the client does not exist or if there are
	 *                                  vehicles registered for this client
	...
	/**
	 * Updates values for the client specified by the id field, except id and dni
	 * 
	 * @param client A dto identifying the client to update by the field id, and new
	 *               data in the other fields
	 * @throws BusinessException        if the client does not exist
	 * @throws IllegalArgumentException when the argument is null or id is null or
	 *                                  empty
	 */
	 ...
	 * @throws IllegalArgumentException when argument is null or empty string DOES
	 *                                  NOT throw BusinessException
	 */
	Optional<ClientBLDto> findClientById(String idClient) throws BusinessException;

	/**
	 * @param sponsorID The id of the client who recommended the workshop to this
	 *                  client
	 * @return the dto for the clients or empty if there is none recommended by the
	 *         argument
	 * @throws IllegalArgumentException when argument is null or empty string DOES
	 *                                  NOT throw BusinessException
	 */
