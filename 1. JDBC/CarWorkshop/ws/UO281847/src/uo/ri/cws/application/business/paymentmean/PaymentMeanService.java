...
public interface PaymentMeanService {
	 ...
	 * 
	 * @param card
	 * @throws BusinessException        in case of: - Client does not exist. - There
	 *                                  is another card registered with the same
	 *                                  card number - The card to be inserted is
	 *                                  outdated (expiration date before today)
	 * @throws IllegalArgumentException if - The dto is null. - Any field of the
	 *                                  following fields is null: id,
	 *                                  cardExpiration, cardNumber, cardType,
	 *                                  clientId - Any field of the following fields
	 *                                  is empty: id, cardNumber, cardType, clientId
	 * 
	 */
	 ...
	 * @param voucher
	 * @throws BusinessException        in case of: - Client does not exist. - There
	 *                                  is another voucher registered with the same
	 *                                  code
	 * @throws IllegalArgumentException if - The dto is null. - Any field of the
	 *                                  following fields is null: code, description
	 *                                  or client id - Any field of the following
	 *                                  fields is empty: code, description or client
	 *                                  id - Field balance is negative
	 */
	 ...
	 * 
	 * @param id
	 * @throws BusinessException        in case of: - There is no payment mean with
	 *                                  such id. - Cash can not be removed. - The
	 *                                  payment mean has charges.
	 ...
	 * 
	 * @param id
	 * @return A list with payment means or empty if there is no payment mean for
	 *         the client
	 * @throws BusinessException        DOES NOT
	 * @throws IllegalArgumentException if the argument is null or blank
	 */
