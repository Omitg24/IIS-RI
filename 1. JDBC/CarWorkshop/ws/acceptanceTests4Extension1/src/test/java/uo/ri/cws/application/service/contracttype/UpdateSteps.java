...
public class UpdateSteps {
	...
	private ContractTypeBLDto updated_dto = null;
	Optional<ContractTypeBLDto> found_dto = null;
	private ContractTypeBLDto before = null;
	private Optional<ContractTypeBLDto> after = null;
	...
	public void i_try_to_add_a_contract_type_with_null_name() {
		ContractTypeBLDto dto = new ContractTypeUtil().withName(null).get();
	...
	public void i_try_to_add_a_contract_type_with(String arg)  {
		ContractTypeBLDto dto = new ContractTypeUtil().withName(arg).get();
		tryUpdateAndKeepException(dto);
	...
	public void i_try_to_update_a_contract_type_with_negative_days() {
		ContractTypeBLDto dto = new ContractTypeUtil().withDays(-10).get();
		tryUpdateAndKeepException(dto);
	...
	public void i_try_to_update_a_non_existent_contract_type() {
		ContractTypeBLDto dto = new ContractTypeUtil().withName(UUID.randomUUID().toString()).get();
		tryUpdateAndKeepException(dto);
	}
	...
	public void i_update_a_contract_type() throws BusinessException {
		...
		updated_dto = new ContractTypeBLDto();
	...
	private void tryUpdateAndKeepException(ContractTypeBLDto arg) {
		try {
