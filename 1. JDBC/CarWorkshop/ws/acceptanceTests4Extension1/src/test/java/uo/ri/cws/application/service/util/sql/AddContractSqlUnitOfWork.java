...
public class AddContractSqlUnitOfWork {
	...
	public AddContractSqlUnitOfWork(ContractBLDto dto) {
		this.connectionData = PersistenceXmlScanner.scan();
		this.dto = dto;
	}

	public AddContractSqlUnitOfWork(ContractBLDto dto, String mechanicId, String contractTypeId, String professionalGroupId) {
		this.connectionData = PersistenceXmlScanner.scan();
		this.dto = dto;
