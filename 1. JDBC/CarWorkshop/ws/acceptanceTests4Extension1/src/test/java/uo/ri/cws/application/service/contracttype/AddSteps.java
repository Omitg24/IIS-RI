...
public class AddSteps {
	...
	private ContractTypeBLDto ct_dto = null;
	...
	public void i_try_to_add_a_professional_group_with_repeated_name() {
		...
		ContractTypeBLDto newCt = new ContractTypeBLDto();
	...
	public void the_professional_group_is_added(DataTable table) {
		...
		finder.execute();
		Optional<ContractTypeBLDto> found = finder.get();
	...
	private void tryAddAndKeepException(ContractTypeBLDto arg) {
		try {
