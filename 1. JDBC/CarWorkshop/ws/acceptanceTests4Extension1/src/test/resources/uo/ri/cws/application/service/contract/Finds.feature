...
Feature: Find contracts
  ...
  @FindById
  Scenario: Find a non existent contract
 ...
 @FindByMechanicId
  Scenario: Find contracts for a non existent mechanic 
    When I search contracts for a non existent mechanic
    Then List of contracts summary is empty

  Scenario: Find contracts for an existent mechanic with no contracts 
    When I search contracts for a non existent mechanic
    Then List of contracts summary is empty
    
  Scenario: Find contracts for an existent mechanic with no contracts in force and one terminated contract
  ...
  Scenario: Find contracts for existent mechanic with several contracts terminated and one contract in force with no payrolls
      Given the following mechanic
      | dni  	| name  | surname   |
  ...
  Scenario: Find contracts for an existent mechanic with several contracts terminated and one contract in force with several payrolls
      Given the following mechanic
      | dni  	| name  | surname   |
