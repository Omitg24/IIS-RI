Feature: Generate payrolls for mechanics this current month
 ...
 Scenario: Generate payrolls for no mechanic in force this month
  ...
  | DNI-1 | Name-1| Surname-1 | PERMANENT | I | TERMINATED  | "01-06-2020" 	| 8400.0			|  600.0					| 600.0		| 0.0										| 0.0						| 228.0	| 35.0	| "31-12-2021"		|
   | DNI-1 | Name-1| Surname-1 | PERMANENT | I | TERMINATED| "01-06-2009" 	| 8400.0			|  600.0					| 600.0		| 0.0										| 186.96  	| 263.52 | 35.0	| "31-12-2021"		|
   | DNI-1 | Name-1| Surname-1 | PERMANENT | I | TERMINATED| "01-06-2020" 	| 8400.0			|  600.0					| 0.0					| 0.0										| 0.0						| 114.0	| 35.0	| "30-11-2021"		|
  | DNI-1 | Name-1| Surname-1 | PERMANENT | I | TERMINATED| "01-06-2009" 	| 8400.0			|  600.0					| 0.0		      | 0.0										| 186.96  	| 149.52	 | 35.0	| "30-11-2021"		|

| DNI-1 | Name-1| Surname-1 | PERMANENT | I | TERMINATED    | "01-06-2020" 	| 84000.0			|  6000.0					| 6000.0		| 0.0										| 0.0						| 5400.0	| 350.0	| "31-12-2021"		|
    | DNI-1 | Name-1| Surname-1 | PERMANENT | I | TERMINATED| "01-06-2009" 	| 84000.0			|  6000.0					| 6000.0		| 0.0										|186.96	  	| 5484.13	 | 350.0	| "31-12-2021"		|
    | DNI-1 | Name-1| Surname-1 | PERMANENT | I | TERMINATED| "01-06-2020" 	| 84000.0			|  6000.0					| 0.0					| 0.0										| 0.0						| 2700.0	| 350.0	| "30-11-2021"		|
    | DNI-1 | Name-1| Surname-1 | PERMANENT | I | TERMINATED| "01-06-2009" 	| 84000.0			|  6000.0					| 0.0		      | 0.0										| 186.96  	| 2784.13	 | 350.0	| "30-11-2021"		|
  ...
  Scenario: Generate payrolls for mechanics in force only
      ...
      | dni  	| name  | surname   | type | group | state |
      | DNI-7 | Name-7| Surname-7 | PERMANENT | I | TERMINATED |
      | DNI-8 | Name-8| Surname-8 | PERMANENT | I |TERMINATED |
      | DNI-9 | Name-9| Surname-9 | PERMANENT | I |TERMINATED |
      |DNI-10 | Name-10| Surname-10 | TEMPORARY | II |IN_FORCE |
      | DNI-11 | Name-11| Surname-11 | TEMPORARY | II |IN_FORCE |
    When I generate payrolls  
