Feature: Find contract type
  ...
  @FindById
  @IllegalArguments
  Scenario: Try to find a contract type with null id
    When I try to find a contract type with null id
    Then argument is rejected with an explaining message
    
  Scenario Outline: Try to find a contract type with wrong arg
    When I try to find a contract type with arg <arg>
    Then argument is rejected with an explaining message
