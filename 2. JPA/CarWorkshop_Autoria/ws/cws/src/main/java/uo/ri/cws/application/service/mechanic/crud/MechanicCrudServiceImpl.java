...
import uo.ri.cws.application.service.mechanic.crud.command.FindMechanicsWithExpensiveRepairs;
...
public class MechanicCrudServiceImpl implements MechanicCrudService {
	...
	/**
     * 
     * @return The list of mechanics that have an intervention on a workorder
     *         with a minimun amount of 3000 € 
     *
     * @throws BusinessException DOES NOT
     */
	@Override
	public List<MechanicDto> findMechanicsWithExpensiveRepairs() throws BusinessException {
		return executor.execute(new FindMechanicsWithExpensiveRepairs());
	}
