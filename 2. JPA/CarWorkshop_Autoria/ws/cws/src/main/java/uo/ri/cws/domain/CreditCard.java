...
public class CreditCard extends PaymentMean {
	...
	public CreditCard(String number, String type, LocalDate validThru) {
		ArgumentChecks.isNotBlank(number, "El número de la tarjeta no puede ser null ni estar vacío");
		ArgumentChecks.isNotBlank(type, "El tipo de la tarjeta no puede ser null ni estar vacío");
