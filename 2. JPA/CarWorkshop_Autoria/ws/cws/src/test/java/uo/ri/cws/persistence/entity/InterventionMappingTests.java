...
public class InterventionMappingTests {
	...
	/**
	 * When two interventions have the same mechanic, workOrder and date, then the
	 * second cannot be added
	 */
	@Test(expected = PersistenceException.class)
	public void testRepeated() {
		Intervention repeatedIntervention = new Intervention(intervention.getMechanic(), intervention.getWorkOrder(),
