...
//		Associations.Charges.link(invoice, charge, cash);
	...
	public void testInvoiceSafeReturn() {
		...
		assertTrue("It must be a copy of the collection", invoice.getCharges().contains(charge));
	...
	public void testCashInvoiceSafeReturn() {
		...
		assertTrue("It must be a copy of the collection", cash.getCharges().contains(charge));
