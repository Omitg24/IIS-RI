 ...
 * @version 16 nov 2022
 */
public class FindMechanicsWithExpensiveRepairsAction implements Action {
	/**
	 * Método execute
	...
	public void execute() throws BusinessException {		
		...
		List<MechanicDto> mechanics = mService.findMechanicsWithExpensiveRepairs();
		
		// Show result
		Console.println("\nList of mechanics with expensive repairs\n");
