...
public class SubstituteMappingTests {
	...
	public void setUp() {
		...
		unitOfWork.persist(workOrder, vehicle, invoice, mechanic, intervention, vehicleType, substitution, sparePart);
	}

	@After
	public void tearDown() {
		unitOfWork.remove(workOrder, vehicle, invoice, mechanic, intervention, vehicleType, substitution, sparePart);
		factory.close();
	}
	...
	public void testInterventionRecoversSubstitutions() {
		...
		Intervention restored = unitOfWork.findById(Intervention.class, intervention.getId());
