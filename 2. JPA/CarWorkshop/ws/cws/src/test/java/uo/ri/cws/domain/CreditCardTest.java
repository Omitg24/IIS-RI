...
public class CreditCardTest {
	...
	/**
	 * A credit card created with the basic constructor has one day validity and is
	 * of UNKNOWN type
	 */
	@Test
	public void testSimpleConstructor() {
		...
		assertTrue(t.getValidThru().isBefore(in24HoursTime) || t.getValidThru().equals(in24HoursTime));
	...
	public void testNotValidAfterDate() {
		CreditCard t = new CreditCard("123", "VISA", LocalDate.now().minusDays(1));
	...
	/**
	 * If validity date is changed to past and the card is used to pay an exception
	 * is raised
	 */
	@Test(expected = IllegalStateException.class)
	public void testSetAndTryToPayAfterDate() {
		CreditCard t = new CreditCard("123", "VISA", LocalDate.now().plusDays(1));
		t.pay(10);
