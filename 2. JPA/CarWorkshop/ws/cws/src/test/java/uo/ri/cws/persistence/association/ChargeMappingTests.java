...
public class ChargeMappingTests {
	...
	public void setUp() {
		...
		card = new CreditCard("1234-5678", "visa", LocalDate.now().plus(1, ChronoUnit.MONTHS));
		...
		unitOfWork.persist(client, cash, voucher, card, invoice, chargeWithCash, chargeWithCard, chargeWithVoucher);
	}

	@After
	public void tearDown() {
		unitOfWork.remove(client, cash, voucher, card, invoice, chargeWithCash, chargeWithCard, chargeWithVoucher);
		factory.close();
	}
