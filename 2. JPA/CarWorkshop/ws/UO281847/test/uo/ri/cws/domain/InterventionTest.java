...
public class InterventionTest {
	...
	public void testAmountsZero() {
		...
		assertEquals(i.getAmount(), 0.0, Double.MIN_VALUE);
	}
	...
	public void testAmountOneHour() {
		...
		assertEquals(i.getAmount(), vehicleType.getPricePerHour(), Double.MIN_VALUE);
	}
	...
	public void testImporteRepuesto() {
		...
		assertEquals(i.getAmount(), r.getPrice(), Double.MIN_VALUE);
	}
	...
	public void testImporteIntervencionCompleta() {
		...
		assertEquals(i.getAmount(), TOTAL, Double.MIN_VALUE);
	}
