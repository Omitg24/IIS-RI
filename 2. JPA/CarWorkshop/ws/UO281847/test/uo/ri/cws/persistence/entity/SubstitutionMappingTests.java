...
public class SubstitutionMappingTests {
	...
	public void setUp() {
		...
		unitOfWork.persist(vehicleType, mechanic, vehicle, intervention, workOrder, sparePart, substitution);
	}

	@After
	public void tearDown() {
		unitOfWork.remove(vehicleType, mechanic, vehicle, intervention, workOrder, sparePart, substitution);
		factory.close();
	}
	...
	public void testAllFieldsPersisted() {
		...
		Substitution restored = unitOfWork.findById(Substitution.class, substitution.getId());
	...
	public void testRepeated() {
		Substitution repeated = new Substitution(substitution.getSparePart(), substitution.getIntervention(), 100);
