...
public class InterveneMappingTests {
	...
	public void setUp() {
		...
		unitOfWork.persist(workOrder, vehicle, invoice, mechanic, intervention, vehicleType);
	}

	@After
	public void tearDown() {
		unitOfWork.remove(workOrder, vehicle, invoice, mechanic, intervention, vehicleType);
		factory.close();
	}
