...
public class CreditCardMappingTests {
	...
	public void setUp() {
		...
		creditCard = new CreditCard("1234-5678", "card-type", LocalDate.now().plus(1, ChronoUnit.YEARS));
	...
	public void testAllFieldsPersisted() {
		CreditCard restored = unitOfWork.findById(CreditCard.class, creditCard.getId());
	...
	public void testRepeated() {
		CreditCard repeated = new CreditCard(creditCard.getNumber(), "another-card-type", LocalDate.now());
