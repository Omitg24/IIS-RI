...
public class DtoAssembler {
	...
	public static PayrollBLDto toDto(Payroll payroll) {
		...
		dto.netWage = payroll.getMonthlyWage() + payroll.getBonus() + 
				payroll.getProductivityBonus() + payroll.getTrienniumPayment() - 
				payroll.getIncomeTax() - payroll.getNIC();
		
		return dto;
	}
	
	public static List<PayrollBLDto> toPayrollDtoList(List<Payroll> list) {
		return list.stream().map(a -> toDto(a)).collect(Collectors.toList());
	}
	
	public static PayrollSummaryBLDto toSummaryDto(Payroll payroll) {
