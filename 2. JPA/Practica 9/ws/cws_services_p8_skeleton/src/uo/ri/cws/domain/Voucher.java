...
public class Voucher extends PaymentMean {
	...
	public Voucher(String code, String description, double available) {		
		ArgumentChecks.isNotEmpty(code, "El código del bono no puede ser null o estar vacío");
		ArgumentChecks.isNotEmpty(description, "La descripción del bono no puede ser null o estar vacía");
		ArgumentChecks.isTrue(available >= 0.0, "La cantidad del bono debe de ser mayor o igual a cero");
	...
	public void pay(double amount) {
		StateChecks.isTrue(amount <= available, "La cantidad a pagar debe de ser "
				+ "menor que la cantidad disponible del bono");
		super.pay(amount);
