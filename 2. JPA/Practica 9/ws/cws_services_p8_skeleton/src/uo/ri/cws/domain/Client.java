...
public class Client extends BaseEntity {
	...
	public Client(String dni, String name, String surname, String email, String phone, Address address) {
		ArgumentChecks.isNotEmpty(dni, "El dni del cliente no puede ser null ni estar vacío");
		ArgumentChecks.isNotEmpty(name, "El nombre del cliente no puede ser null ni estar vacío");
		ArgumentChecks.isNotEmpty(surname, "El apellido del cliente no puede ser null ni estar vacío");
